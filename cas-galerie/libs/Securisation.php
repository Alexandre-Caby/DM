...
include_once "Utils.php";  // Car on utilise la fonction valider()
...
function verifUser($login,$password)
{
  ...
  $id = verifUtilisateurBdd($login,$password);

  if (!$id) return false; 

  // Cas succès : on enregistre des données dans les variables de session 
